package com.abhicoder.journeymate.DatabaseConstant;
...
public class Constants {
    ...
    public static final String KEY_TRANSACTION_HISTORY="transactionhistory";

    public static final String KEY_COLLECTION_ACTIVE_USERS="ActiveUsers";
